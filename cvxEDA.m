...
% hold on;
% plot(knots, l,'LineWidth',1.5);
% plot(B*l,'LineWidth',1.5);
% plot(B*l+C*d,'LineWidth',1.5);
% legend('EDA raw', 'l(knots) spaced every 10 s', 'B*l (Splined)', 'B*l + C*d (convex Tonic, adding linear component)');
end